...
1. **Persistent Local Storage:**
    Automatically saves all data to tasks.txt and loads it upon startup.
...
| v1.0.9 | 1 Jun 2026 | Added option to modify tasks/subtasks, status, due date, mark done |
...
| v1.0.1 | 1 Jun 2026 | Fixed input errors: DayDateTime parse and Scanner issues |
| v1.0.0 | 1 Jun 2026 | Initial release: Task Manager CLI with file persistence |
